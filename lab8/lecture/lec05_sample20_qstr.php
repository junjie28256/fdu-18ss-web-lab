<?php 
	...
	if($name == "")
		header("Location: http://localhost:8080/zdl/lec05_sample20_qstr.htm");
	else
		if($flag == 1){
?>
<!DOCTYPE html>
<html>
  ...
  <body>	
	...
	<form method="get" action="http://localhost:8080/zdl/lec05_sample20_qstr.php" id="form1" name="form1">
