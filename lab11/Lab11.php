...
//$sql = "SELECT cities,countries,continetnts,imagedetaile,imagerating,postimages,posts,userdetails,users FROM travel";
...
<body>
    ...
    <main class="container">
		...
		<ul class="caption-style-2">
            ...
            $aaa = $_GET['continent'];
            $bbb = $_GET['country'];
            $sql = "SELECT Path,ImageID,Description FROM imagedetails WHERE ContinentCode ='$aaa' AND CountryCodeISO = '$bbb'";
            $result = $conn->query($sql);
